  ...
  return (
    <div className="contact-form">
      <form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        {errors.user_name ? (
          <p className="message"> {errors.user_name.message} </p>
        ) : (
          ""
        )}
        <input
          ...
          {...register("user_subject", {
            required: t("user_subject_required"),
          })}
        />
        {errors.user_subject ? (
        ...
        <input
          placeholder="Email"
          {...register("user_email", {
            required: t("user_email_required"),
            pattern: {
              value:
        ...
        />
        {errors.user_email ? (
          <p className="message">{errors.user_email.message}</p>
        ) : (
          ""
        )}
        <textarea
          ...
          {...register("message", {
            ...
            minLength: { value: 15, message: t("message_min_length") },
          })}
        ></textarea>
        {errors.message ? (
